...
@if (auth()->guard('admin')->user()->hasPermission('create_types'))
    ...
    <a class="dropdown-item" href="{{ route('admin.bosla-types.create') }}"><i class="mdi mdi-plus-circle"></i> اضافه نوع جديد</a>
@endif
    @endsection
                                ...
                                @foreach ($types as $index=>$type)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a title="edit" href="{{ route('admin.bosla-types.edit',$type->id) }}" class="btn btn-icon btn-success text-white mx-1"><i class="mdi mdi-square-edit-outline  "></i></a>
                                            @endif
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form
                                                                        action="{{ route('admin.bosla-types.destroy',$type->id) }}"
                                                                        method="post">
                                                                        {{ method_field('Delete') }}
                                                                        @csrf
                                                                          هل متاكد من الحذف
